...
*  - holds a falg string to show the status of the check-in file : open, cleosd or pending
...
*  --------------------
*  ver 1.2 : 3  Mar 2018
*  - added flag string and functions to modify check-in file's status
*  ver 1.1 : 19 Feb 2018
...
namespace NoSqlDb
{
  ...
  public:
	...
	void  categories(std::vector<std::string>& categories) { categories_ = categories; }
  ...
  */
  ...
  inline void PayLoad::showElementPayLoad(NoSqlDb::DbElement<PayLoad>& elem, std::ostream& out)
  {
	...
	out << std::setw(10) << std::left << elem.payLoad().flag().substr(0,8);
